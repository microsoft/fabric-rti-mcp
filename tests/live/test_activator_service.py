...
def verify_artifact_in_list(workspace_id: str, artifact_id: str) -> None:
    ...
    try:
        ...
        print("✅ Successfully retrieved artifacts list")
        ...
        if found_artifact:
            print("✅ Successfully found our artifact in the list!")
...
def run_activator_triggers_sequence(workspace_id: str, kql_cluster_url: str, kql_database: str, kql_query: str):
    """
    ...
    Args:
        ...
        kql_query: The KQL query to use for the trigger
    """
    print("Testing activator trigger creation sequence...")
...
def main():
    ...
    parser.add_argument("--workspace-id", required=True, help="The Fabric workspace ID (UUID)")
    parser.add_argument(
        "--kql-cluster-url", required=True, help="The KQL cluster URL (e.g., https://mycluster.kusto.windows.net)"
    )
    parser.add_argument("--kql-database", required=True, help="The KQL database name")
    parser.add_argument("--kql-query", required=True, help="The KQL query to use for the trigger")
    ...
    run_activator_triggers_sequence(
