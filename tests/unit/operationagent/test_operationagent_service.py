...
def test_operationagent_get_definition_uses_get_definition_endpoint(mock_http_client: MagicMock) -> None:
    ...
    result = operationagent_service._operationagent_get_definition(workspace_id, item_id)
...
def test_operationagent_update_definition_encodes_definition(mock_http_client: MagicMock) -> None:
    ...
    result = operationagent_service._operationagent_update_definition(workspace_id, item_id, definition)
...
def test_operationagent_get_goals_extracts_goals_from_configurations_json(mock_http_client: MagicMock) -> None:
    ...
    result = operationagent_service.operationagent_get_goals(workspace_id, item_id)

    assert result == {"goals": "monitor my fabric"}


def test_operationagent_get_instructions_extracts_instructions_from_configurations_json(
    ...
    result = operationagent_service.operationagent_get_instructions(workspace_id, item_id)

    assert result == {"instructions": "do the thing"}


def test_operationagent_get_knowledge_sources_extracts_data_sources_as_list(mock_http_client: MagicMock) -> None:
    config_doc: dict[str, Any] = {
        "configuration": {
            "goals": "x",
            "instructions": "y",
    ...
    result = operationagent_service.operationagent_get_knowledge_sources(workspace_id, item_id)
...
def test_operationagent_get_actions_extracts_actions_dict(mock_http_client: MagicMock) -> None:
    config_doc: dict[str, Any] = {
        "configuration": {
            "goals": "x",
            "instructions": "y",
    ...
    result = operationagent_service.operationagent_get_actions(workspace_id, item_id)
...
def test_operationagent_get_goals_returns_none_when_configuration_missing(mock_http_client: MagicMock) -> None:
...
def test_operationagent_get_instructions_returns_none_when_configuration_not_object(
    mock_http_client: MagicMock,
) -> None:
...
def test_operationagent_get_knowledge_sources_returns_empty_when_configuration_invalid(
    mock_http_client: MagicMock,
) -> None:
...
def test_operationagent_get_actions_returns_empty_when_actions_not_object(mock_http_client: MagicMock) -> None:
...
def test_operationagent_set_goals_updates_config_and_calls_update_definition(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    result = operationagent_service.operationagent_set_goals(workspace_id, item_id, "new goals")
...
def test_operationagent_set_instructions_updates_config_and_calls_update_definition(
    mock_http_client: MagicMock,
) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    config_doc: dict[str, Any] = {
        "configuration": {"goals": "g", "instructions": "old", "dataSources": {}, "actions": {}}
    }
    mock_http_client.make_request.side_effect = [_make_get_definition_response(config_doc), {"ok": True}]

    result = operationagent_service.operationagent_set_instructions(workspace_id, item_id, "new instructions")
...
def test_operationagent_add_knowledge_source_inserts_into_data_sources(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"

    config_doc: dict[str, Any] = {
        "configuration": {"goals": "g", "instructions": "i", "dataSources": {}, "actions": {}}
    }
    mock_http_client.make_request.side_effect = [_make_get_definition_response(config_doc), {"success": True}]

    knowledge_source = {"type": "KustoDatabase", "workspaceId": "w1"}
    result = operationagent_service.operationagent_add_knowledge_source(
...
def test_operationagent_remove_knowledge_source_removes_and_updates(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    result = operationagent_service.operationagent_remove_knowledge_source(workspace_id, item_id, "ds1")
...
def test_operationagent_remove_knowledge_source_noop_when_missing_does_not_update(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    result = operationagent_service.operationagent_remove_knowledge_source(workspace_id, item_id, "missing")
    assert result == {"removed": False, "knowledge_source_id": "missing"}
    assert mock_http_client.make_request.call_count == 1


def test_operationagent_add_action_inserts_into_actions(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    action = {"type": "Notify"}
    result = operationagent_service.operationagent_add_action(workspace_id, item_id, action=action, action_id="a1")
...
def test_operationagent_remove_action_removes_and_updates(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    result = operationagent_service.operationagent_remove_action(workspace_id, item_id, "a1")
    assert result["removed"] is True
...
def test_operationagent_remove_action_noop_when_missing_does_not_update(mock_http_client: MagicMock) -> None:
    workspace_id = "0b67c1e8-04cb-4b05-9e7a-e4c2c8db7d8a"
    item_id = "87654321-0000-1111-2222-123456789abc"
    ...
    result = operationagent_service.operationagent_remove_action(workspace_id, item_id, "missing")
