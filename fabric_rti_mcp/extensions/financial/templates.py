...
class FinancialKQLTemplates:
    ...
    def get_moving_average_query(
        self, table_name: str, value_column: str, time_column: str, window_size: int
    ) -> str:
        """
...
| extend MovingAverage = series_fir({value_column},
    dynamic(array_repeat(1.0/{window_size}, {window_size})), false, false)
