...
class GlobalFabricRTIConfig:
    ...
    def from_env() -> GlobalFabricRTIConfig:
        return GlobalFabricRTIConfig(
            ...
            use_ai_foundry_compat=bool(os.getenv(GlobalFabricRTIEnvVarNames.use_ai_foundry_compat, DEFAULT_FABRIC_RTI_AI_FOUNDRY_COMPATIBILITY_SCHEMA)),
        )
    ...
    def with_args() -> GlobalFabricRTIConfig:
        ...
        parser.add_argument("--use-ai-foundry-compat", action="store_true", help="Enable or disable AI Foundry compatibility mode")
        ...
        use_ai_foundry_compat=args.use_ai_foundry_compat if args.use_ai_foundry_compat is not None else base_config.use_ai_foundry_compat
